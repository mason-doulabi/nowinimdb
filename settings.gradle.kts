...
include(":i_core:testing")
include(":i_core:navigation")
include(":i_feature:movies:api")
include(":i_feature:movies:impl")
include(":i_feature:search:api")
include(":i_feature:search:impl")
include(":i_feature:profile:api")
include(":i_feature:profile:impl")
